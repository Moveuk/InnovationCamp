...
public class ReplyController {
    ...
    @PostMapping(path = "/api/replies/{id}")
    @ApiOperation(value = "댓글 작성", notes = "댓글을 작성한다.")
    public Long createReply(@PathVariable Long id, @Valid @RequestBody ReplyRequestDto replyRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        System.out.println("userDetails = " + userDetails.getUsername());
        replyRequestDto.setPostId(id);
    ...
    @ApiImplicitParam(name = "id", value = "Reply Entity Id값")
    public Long updatePost(@PathVariable Long id, @RequestBody @ApiIgnore ReplyRequestDto replyRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    @ApiImplicitParam(name = "id", value = "Reply Entity Id값")
    public Long deletePost(@PathVariable Long id, @RequestBody @ApiIgnore ReplyRequestDto replyRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        return replyService.delete(id, replyRequestDto, userDetails);
    }
}
